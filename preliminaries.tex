...
\begin{enumerate}
  \item Lines $n-1$ and $n$ have the same canalyzed value ~and
  \item each pair of consecutive lines
        with the same canalyzed value occur in the lexicographic order 
...
each maximal sequence of consecutive lines with the same canalyzed value,
