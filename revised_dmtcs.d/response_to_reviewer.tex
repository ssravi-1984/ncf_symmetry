...
input.} 
After the statement of the theorem, we have pointed out that
...
If $r$ depends on $n$, then the input size and the running time of the
algorithm are not polynomial functions of $n$.
\end{enumerate}
